...
(function () {
  ...
  const TOPBAR_SUPABASE_URL = 'https://szelyvlqzruwnwhnuchb.supabase.co';
  const TOPBAR_SUPABASE_KEY = 'sb_publishable_G-znLn3MKl9EIK6w4jL3LQ_811bZKzz';
...
.topbar-home-icon { font-size: 15px; line-height: 1; }
...
@media (max-width: 480px) {
  ...
  .topbar-home-btn { height: 38px; padding: 0 10px; font-size: 12px; }
...
<header class="topbar" id="topbar" role="navigation" aria-label="Quick actions">
  <a href="index.html" class="topbar-home-btn" id="topbarHome" aria-label="Back to all tiles" title="All tiles">
    <span class="topbar-home-icon">⊞</span>
    <span class="topbar-home-label">Tiles</span>
  </a>
...
<nav class="bottombar" id="bottombar" role="navigation" aria-label="Main tabs">
  <div class="bottombar-inner">
    ...
    <a href="supplements.html" class="bottombar-tab" data-page="supplements">
      <span class="bottombar-tab-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 3H5a2 2 0 0 0-2 2v4m6-6h10a2 2 0 0 1 2 2v4M9 3v18m0 0h10a2 2 0 0 0 2-2v-4M9 21H5a2 2 0 0 0-2-2v-4m0 0h18"/></svg></span>
      Fuel
    </a>
  </div>
</nav>`;
  ...
  function currentPageKey() {
    ...
    if (p.endsWith('supplements.html')) return 'supplements';
